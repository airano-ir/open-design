...
export const zhCN: Dict = {
  ...
  "integrations.tabLabel.agentPlugin": "智能体插件",
  ...
  "agentPlugin.lede":
    "把 Open Design 插件装进你的编码智能体：工作流技能教会它通过本地守护进程生成幻灯片、页面和品牌产物，实时预览，并在它自己的浏览器里做视觉验证。",
  "agentPlugin.copy": "复制",
  "agentPlugin.copied": "已复制",
  "agentPlugin.bundleMeta": "插件包 v{version} · {count} 个工作流技能 + stdio MCP 服务器",
  "agentPlugin.hostDetected": "已检测到",
  "agentPlugin.hostMissing": "不在 PATH",
  "agentPlugin.browserVerify": "视觉验证在 {browser} 中进行。",
  "agentPlugin.install": "安装",
  "agentPlugin.installing": "安装中…",
  "agentPlugin.uninstall": "卸载",
  "agentPlugin.uninstalling": "移除中…",
  "agentPlugin.requestFailed": "守护进程无响应——请确认 Open Design 正在运行后重试。",
  "agentPlugin.loadFailed": "无法从守护进程加载宿主状态。",
