...
export const zhCN: Dict = {
  ...
  "brand.failed": "提取失败",
  "brand.artifact.landing": "落地页",
  "brand.artifact.deck": "演示文稿",
  "brand.artifact.poster": "海报",
  "brand.artifact.email": "邮件",
  "brand.artifact.newsletter": "邮件订阅",
  "brand.artifact.form": "表单页",
