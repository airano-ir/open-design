...
export const zhCN: Dict = {
  ...
  'task.followup.details': '深入分析「{topic}」的关键实现细节。',
  'task.followup.report': '基于当前结果，生成一份关于「{topic}」的详细报告。',
  'task.followup.demo': '把当前结果做成一个可交互的网页演示。',
  ...
  "chat.usage.title": "用量",
  "chat.usage.tokensUsed": "Token 用量",
  "chat.usage.timeWorked": "工作时间",
  "chat.usage.inputTokens": "输入 Token",
  "chat.usage.outputTokens": "输出 Token",
  "chat.usage.cost": "金额",
  "chat.usage.rounds": "轮次",
