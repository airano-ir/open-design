...
export const zhCN: Dict = {
  ...
  "chat.example4Prompt": "为生产力应用发布创建 15 秒动态视频分镜：开场钩子、UI 特写、动态文字、功能转场、结尾 logo 和 CTA。包含时间点、场景描述、镜头运动和文字叠加。",
  "chat.example4Tag": "动效",
  "chat.example4Title": "产品动态视频",
  "chat.referenceProject.confirm": "引用项目",
  "chat.referenceProject.emptyAll": "暂无其他项目",
  "chat.referenceProject.empty": "没有匹配“{query}”的项目",
  "chat.referenceProject.search": "搜索项目",
  "chat.referenceProject.title": "引用项目",
  "chat.referenceProject.loadFailed": "无法加载项目。",
  "chat.plus.mcp": "MCP",
  ...
  "chat.plus.referenceProject": "引用项目",
  "chat.plus.attachFiles": "添加文件",
