...
export const zhCN: Dict = {
  ...
  "settings.about": "关于",
  "settings.aboutHint": "更新、支持与产品信息",
  "settings.aboutTagline": "面向智能体设计的开源工作空间。",
  "settings.aboutUpdates": "更新",
  "settings.aboutWebsite": "网站",
  "settings.aboutOpenSource": "开源项目",
  "settings.aboutCommunity": "社区",
  "settings.aboutLicense": "开源许可",
  "settings.aboutSupport": "支持",
  "settings.aboutReportBug": "报告问题",
  "settings.aboutSendFeedback": "提交反馈",
  "settings.aboutAdvancedDetails": "高级运行环境详情",
  "settings.aboutTroubleshooting": "故障排查",
