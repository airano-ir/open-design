...
export const zhTW: Dict = {
  ...
  "chat.example4Prompt": "為生產力應用發布建立 15 秒動態影片分鏡：開場鉤子、UI 特寫、動態文字、功能轉場、結尾 logo 和 CTA。包含時間點、場景描述、鏡頭運動和文字疊加。",
  "chat.example4Tag": "動態",
  "chat.example4Title": "產品動態影片",
  ...
  "chat.referenceProject.title": "引用專案",
  "chat.referenceProject.loadFailed": "無法載入專案。",
  "chat.plus.mcp": "MCP",
  ...
  "chat.plus.referenceProject": "引用專案",
  "chat.plus.attachFiles": "新增檔案",
