...
export const zhTW: Dict = {
  ...
  "integrations.tabLabel.agentPlugin": "智能體外掛",
  ...
  "agentPlugin.lede":
    "把 Open Design 外掛裝進你的編碼智能體：工作流程技能教會它透過本機守護程序生成簡報、頁面與品牌產物，即時預覽，並在它自己的瀏覽器裡做視覺驗證。",
  "agentPlugin.copy": "複製",
  "agentPlugin.copied": "已複製",
  "agentPlugin.bundleMeta": "外掛包 v{version} · {count} 個工作流程技能 + stdio MCP 伺服器",
  "agentPlugin.hostDetected": "已偵測到",
  "agentPlugin.hostMissing": "不在 PATH",
  "agentPlugin.browserVerify": "視覺驗證在 {browser} 中進行。",
  "agentPlugin.install": "安裝",
  "agentPlugin.installing": "安裝中…",
  "agentPlugin.uninstall": "解除安裝",
  "agentPlugin.uninstalling": "移除中…",
  "agentPlugin.requestFailed": "守護程序沒有回應——請確認 Open Design 正在執行後再試一次。",
  "agentPlugin.loadFailed": "無法從守護程序載入宿主狀態。",
