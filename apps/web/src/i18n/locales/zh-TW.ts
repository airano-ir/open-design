...
export const zhTW: Dict = {
  ...
  'task.followup.details': '深入分析「{topic}」的關鍵實作細節。',
  'task.followup.report': '根據目前結果，產出一份關於「{topic}」的詳細報告。',
  'task.followup.demo': '把目前結果做成一個可互動的網頁展示。',
  ...
  "chat.usage.timeWorked": "工作時間",
  "chat.usage.inputTokens": "輸入 Token",
  "chat.usage.outputTokens": "輸出 Token",
  "chat.usage.cost": "金額",
  "chat.usage.rounds": "輪次",
