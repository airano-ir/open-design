...
export const en: Dict = {
  ...
  'agentPlugin.lede':
    'Install the Open Design plugin into your coding agent: workflow skills teach it to generate decks, pages, and brand artifacts through the local daemon, preview them live, and verify results in its own browser.',
  'agentPlugin.copy': 'Copy',
  'agentPlugin.copied': 'Copied',
  'agentPlugin.bundleMeta': 'Bundle v{version} · {count} workflow skills + stdio MCP server',
  'agentPlugin.hostDetected': 'Detected',
  'agentPlugin.hostMissing': 'Not on PATH',
  'agentPlugin.browserVerify': 'Visual verification runs in the {browser}.',
  'agentPlugin.install': 'Install',
  'agentPlugin.installing': 'Installing…',
  'agentPlugin.uninstall': 'Uninstall',
  'agentPlugin.uninstalling': 'Removing…',
  'agentPlugin.requestFailed': 'The daemon did not answer — check that Open Design is running and retry.',
  'agentPlugin.loadFailed': 'Could not load host status from the daemon.',
