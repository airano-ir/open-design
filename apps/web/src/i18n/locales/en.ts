...
export const en: Dict = {
  'chat.amrCard.switchTitle': 'Model call failed â this run is paused',
  'chat.amrCard.switchBody': 'Switch to Open Design\'s official AMR model service â no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.connectionDropped': 'The connection to the model service dropped before the response finished â usually an unstable network or proxy. Please retry.',
  ...
  'chat.runError.signInMessage.amr': 'The Open Design agent isn\'t signed in yet â sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Open Design agent â steadier and better value.',
  ...
  'plugins.availableDetails.provenanceLine': 'from {source} Â· {trust} Â· {resolved}',
  'plugins.availableDetails.provenanceLineWithIntegrity': 'from {source} Â· {trust} Â· {resolved} Â· {integrity}',
  ...
  'app.welcomeLoading': 'Loading workspaceâ¦',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Open Design reuses it on every task â and keeps learning as you work.',
  ...
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away â no complex setup required.',
  ...
  'settings.onboardingGateTooltipNoRuntime': 'The next steps run on AI â pick a runtime to continue.',
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI â sign in to Open Design AMR to continue.',
  'settings.onboardingGateTooltipLocal': 'The next steps run on AI â select an available local CLI to continue.',
  'settings.onboardingGateTooltipByok': 'The next steps run on AI â add and test your model key to continue.',
  ...
  'settings.onboardingRoleAgency': 'ð£ Marketing agency',
  ...
  'settings.testRunning': 'Testing connectionâ¦',
  ...
  'settings.testSuccessApi': 'Connected. Replied in {ms} ms â \'{sample}\'',
  'settings.testSuccessCli': '{agentName} replied in {ms} ms â \'{sample}\'',
  ...
  'settings.amrSigningIn': 'Signing inâ¦',
  'settings.amrActivationHint': 'Sign-in page didn\'t open? Tap the button below to reopen it.',
  'settings.amrActivationBrowserFailed': 'Couldnât open your browser automatically. Open the sign-in page below to continue.',
  ...
  'settings.amrLoggingIn': 'Signing inâ¦',
  'settings.amrLoggingOut': 'Signing outâ¦',
  'settings.amrLoggedInAs': 'Signed in as {email}',
  'settings.amrLoggedInWithPlan': 'Signed in as {email} Â· {plan}',
  ...
  'settings.apiKeyGetLink': 'Get key â',
  ...
  'settings.modelsLoadedFromAccount': 'â Loaded {count} models from your account.',
  'settings.modelsLoadedCount': 'â Loaded {count} models.',
  ...
  'settings.fetchModelsRunning': 'Fetching modelsâ¦',
  ...
  'settings.azureBaseUrlHint': 'Find this in Azure portal â your resource â Endpoint.',
  ...
  'settings.azureModelFetchHint': 'Enter the deployment name from your Azure resource. Azure deployments canât be fetched automatically.',
  ...
  'settings.byokVideoI2vHint': 'Image-to-video model: a reference image is required (the newest project image is used automatically if you donât pick one)',
  ...
  'settings.modelPickerHint': 'Default uses the CLIâs own config. Customâ¦ lets you type any model id.',
  ...
  'settings.modelCustom': 'Custom (type below)â¦',
  ...
  'settings.externalMcpHint': 'Add MCP tools from external services (Higgsfield, GitHub, â¦).',
  ...
  'settings.privacyConsentFooter': 'You can change these any time in Settings â Privacy.',
  ...
  'settings.privacyConsentBannerFooter': 'Data sharing is on by default. You can turn it off any time in Settings â Privacy.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Codeâ¦) read your Open Design projects directly.',
  ...
  'settings.mcpInstructionAntigravity': 'In Antigravity: Agent panel "..." menu â MCP Servers â Manage MCP Servers â View raw config. Merge this JSON.',
  ...
  'settings.mcpInstructionWindsurf': 'Open {path} (or use the MCPs icon in Cascade â Configure) and merge:',
  ...
  'settings.mcpCodexOneClickUnavailable': 'Codex CLI not found on PATH â install Codex or paste the snippet manually.',
  ...
  'settings.mcpCodexBusy': 'Workingâ¦',
  ...
  'entry.loadingWorkspace': 'Loading workspaceâ¦',
  ...
  'homeHero.startWithTemplate': 'Start with a templateâ¦',
  'homeHero.startBlankProject': 'â¦or start a blank project',
  ...
  'homeHero.placeholder': 'Describe what you want to generateâ¦',
  'homeHero.placeholderActive': 'Edit the example query or write your ownâ¦',
  ...
  'homeHero.loadingContext': 'Loading contextâ¦',
  ...
  'workingDirPicker.homeTitle': 'Saved in local storage â click to choose a folder',
  'workingDirPicker.processing': 'Processingâ¦',
  ...
  'workingDirPicker.replace': 'Choose folderâ¦',
  ...
  'designSystemPicker.loading': 'Loading design systemsâ¦',
  ...
  'designSystemPicker.noneSummary': 'No design system â the model freely improvises the visual style from your prompt.',
  'designSystemPicker.empty': 'No matching design systems',
  'designSystemPicker.openPreview': 'Open preview',
  'designSystemPicker.loadingPreview': 'Loading previewâ¦',
  ...
  'recentProjects.empty': 'No projects yet â type a prompt to start one.',
  ...
  'pluginsHome.loadingCatalog': 'Loading catalogâ¦',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Open Design and should appear here automatically â try restarting the daemon if this persists.',
  ...
  'pluginsHome.searchPlaceholder': 'Search pluginsâ¦',
  ...
  'pluginsView.loading': 'Loading pluginsâ¦',
  ...
  'pluginsView.installing': 'Installingâ¦',
  ...
  'pluginsView.refreshing': 'Refreshingâ¦',
  'pluginsView.removing': 'Removingâ¦',
  ...
  'pluginCard.applying': 'Applyingâ¦',
  'pluginCard.publish': 'Publish',
  'pluginCard.contribute': 'Contribute',
  'pluginCard.starting': 'Startingâ¦',
  ...
  'mcpClient.emptyBody': 'Click "Add server" to get started â pick a template (Higgsfield OpenClaw, Pollinations, Allyson, Imagician, EdgeOne Pages, GitHub, Filesystemâ¦) or set up a custom stdio / HTTP server.',
  ...
  'useEverywhere.modalSubtitle': 'Drop Open Design into any IDE, agent, or script â CLI, HTTP, MCP, and Skills. Use âCopy guide for an agentâ and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.footBody': 'Copies a structured markdown guide your agent can act on immediately â install, verify, and use.',
  ...
  'useEverywhere.section.overview.intro': 'Open Design is more than a window â it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI â `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server â wires Open Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  'useEverywhere.section.overview.bullet3': 'HTTP API â `http://127.0.0.1:7456/api/*` REST + SSE endpoints; the same surface the web UI uses.',
  'useEverywhere.section.overview.bullet4': 'Skills â drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Open Design at all.',
  'useEverywhere.section.overview.bullet5': 'Standard artifacts â seed real HTML projects from Skills, bundled default plugins, and community plugin examples before the daemon starts.',
  ...
  'useEverywhere.section.cli.bullet1': '`od` (no args) â boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`od media generate ...` â produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`od run ...` â start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`od plugin install <source>` / `od plugin apply <id>` â install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`od skills list` / `od design-systems list` â inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`od status` / `od doctor` â verify daemon health and detect agent CLIs on your PATH.',
  ...
  'useEverywhere.section.cli.snippet5': 'Verify environment + detected agents (Claude, Codex, Cursor, â¦)',
  'useEverywhere.section.cli.footer': 'All subcommands accept `--daemon-url http://127.0.0.1:<port>` to target a specific running daemon â useful when running a sandboxed second instance for tests.',
  ...
  'useEverywhere.section.mcp.intro': 'Open Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client â Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes â discover Open Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport â no extra port, the client spawns `od mcp` directly.',
  ...
  'useEverywhere.section.mcp.snippet1': 'Generic MCP client config (works in Cursor, Claude Code, Codex, â¦)',
  ...
  'useEverywhere.section.mcp.footer': 'In the Open Design app, open Settings â Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.http.bullet1': '`GET /api/health` â daemon liveness.',
  'useEverywhere.section.http.bullet2': '`GET /api/skills` and `GET /api/design-systems` â available registries.',
  'useEverywhere.section.http.bullet3': '`GET /api/projects` and `POST /api/projects` â list and create projects (POST returns the project + first conversation).',
  'useEverywhere.section.http.bullet4': '`GET /api/projects/:id/chat` â SSE stream of agent events for a conversation.',
  'useEverywhere.section.http.bullet5': '`POST /api/plugins/:id/apply` â bind an installed plugin and get its rendered example query + inputs.',
  'useEverywhere.section.http.bullet6': '`GET /api/agents` â detected code-agent CLIs on your PATH.',
  ...
  'useEverywhere.section.http.snippet3': 'Stream a chat turn (SSE â each line is JSON-Lines compatible)',
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@open-design/contracts` â import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent â even without Open Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Open Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, â¦) so the same artifact can be used both inside Open Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  'useEverywhere.section.skills.bullet1': 'Discovery: `./.claude/skills/` â `./skills/` â `~/.claude/skills/` (project wins).',
  ...
  'tasks.status.dailyAt': 'Daily Â· {time}',
  'tasks.status.pausedManual': 'Paused Â· manual only',
  ...
  'tasks.sample.orbit.previewEnabled': 'orbit_daily.html Â· live artifact',
  'tasks.sample.orbit.previewDisabled': 'No run scheduled',
  'tasks.sample.orbit.triggerEnabled': 'Schedule Â· daily at {time}',
  'tasks.sample.orbit.triggerDisabled': 'Manual Â· run on demand',
  'tasks.sample.orbit.pattern': 'Routine Â· connector digest',
  'tasks.sample.orbit.runtime': 'Orbit Â· daemon scheduled',
  'tasks.sample.orbit.output': 'Live artifact Â· refreshable report',
  ...
  'tasks.sample.weekly.preview': 'team_weekly.md Â· next artifact',
  'tasks.sample.weekly.trigger': 'Schedule Â· weekly',
  'tasks.sample.weekly.pattern': 'Routine Â· team digest',
  'tasks.sample.weekly.runtime': 'Remote Â· recurring',
  'tasks.sample.weekly.output': 'Live artifact Â· markdown',
  ...
  'tasks.sample.pr.status': 'On new PR Â· fired 23m ago',
  'tasks.sample.pr.meta': 'Sends Slack DM',
  'tasks.sample.pr.preview': 'Last delivery succeeded',
  'tasks.sample.pr.trigger': 'Event Â· new PR',
  'tasks.sample.pr.pattern': 'Routine Â· notification',
  'tasks.sample.pr.runtime': 'Local Â· quick run',
  'tasks.sample.pr.output': 'Message Â· Slack DM',
  ...
  'tasks.sample.meeting.status': 'Tomorrow Â· 10:00 AM',
  'tasks.sample.meeting.meta': 'One-shot Â· sends summary',
  'tasks.sample.meeting.preview': 'meeting_brief.md Â· queued',
  'tasks.sample.meeting.trigger': 'Schedule Â· one-shot',
  'tasks.sample.meeting.pattern': 'Briefing prompt',
  'tasks.sample.meeting.runtime': 'Remote Â· bounded',
  ...
  'tasks.sample.candidate.status': 'Failed Â· needs attention',
  'tasks.sample.candidate.meta': 'Auth expired',
  'tasks.sample.candidate.preview': 'Reconnect Greenhouse to resume',
  'tasks.sample.candidate.trigger': 'Schedule Â· daily',
  'tasks.sample.candidate.pattern': 'Routine Â· applicant sync',
  'tasks.sample.candidate.runtime': 'Remote Â· recurring',
  'tasks.sample.candidate.output': 'Live artifact Â· table',
  ...
  'routines.fieldPromptPlaceholder': 'Pull yesterdayâs GitHub + Linear activity and summarize what changed.',
  ...
  'routines.describe.weekdays': 'Runs MonâFri at {time} {tz}',
  ...
  'routines.pickProject': 'â Pick a project â',
  'routines.targetReuse': 'â {project}',
  'routines.targetCreate': 'â new project each run',
  ...
  'routines.save': 'Save',
  'routines.saving': 'Savingâ¦',
  'routines.create': 'Create',
  'routines.creating': 'Creatingâ¦',
  ...
  'routines.errorPickProject': 'Pick a project to reuse, or switch to âCreate new each runâ',
  'routines.errorAgentEmptyOutput': 'Agent completed without producing any output. The model or provider may have returned an empty response â check the agent logs for upstream errors.',
  'entry.helpAria': 'Help',
  ...
  'promptTemplates.searchPlaceholder': 'Search templatesâ¦',
  ...
  'connectors.toolsLoading': 'Loading toolsâ¦',
  ...
  'connectors.searchPlaceholder': 'Search connectorsâ¦',
  'connectors.searchAriaLabel': 'Search connectors by name, provider, or tool',
  'connectors.searchClear': 'Clear search',
  'connectors.emptyNoMatchTitle': 'No connectors match â{query}â',
  ...
  'newproj.toggleSpeakerNotesHint': 'Less text on slides â keep talking points in notes.',
  ...
  'newproj.modelSearch': 'Search modelsâ¦',
  ...
  'newproj.connectorsEmptyCta': 'Set up connectors â',
  'newproj.connectorsLoading': 'Loading connectorsâ¦',
  ...
  'newproj.promptTemplateOptimizeHint': 'Edit anything â your changes carry into the agent\'s brief.',
  'newproj.promptTemplateBodyEmpty': 'Empty body â the agent will get no template reference.',
  ...
  'designs.searchPlaceholder': 'Searchâ¦',
  ...
  'designs.statusRefreshing': 'Refreshingâ¦',
  ...
  'examples.modePrototypeDesktop': 'Prototypes Â· Desktop',
  ...
  'examples.searchPlaceholder': 'Search examplesâ¦',
  ...
  'examples.openPreview': 'â¤¢ Open preview',
  'examples.loadingPreview': 'Loading previewâ¦',
  ...
  'examples.unavailablePlaceholder': 'No shipped {kind} preview â open to learn more',
  'examples.shareUnavailable': 'No shipped {kind} preview to share',
  'examples.shareMenu': 'Share â¾',
  'examples.exportPdfAllSlides': 'Export as PDF (all slides)',
  'examples.exportPptxLocked': 'Export as PPTXâ¦ (open template first)',
  ...
  'ds.searchPlaceholder': 'Search design systemsâ¦',
  ...
  'socialShare.deployFirst': 'Deploy then shareâ¦',
  ...
  'inlineSwitcher.daemonOffline': 'Daemon offline â open settings',
  ...
  'inlineSwitcher.missingApiKey': 'API key not set â open Settings to add it.',
  ...
  'project.customInstructionsPlaceholder': 'Instructions for this project (injected on every message)â¦',
  'project.resizeChatPanel': 'Resize chat panel',
  'project.instructionsActive': 'Active â included in every message',
  'project.missing': 'This project has been deleted or no longer exists.',
  'chat.tabChat': 'Chat',
  'chat.tabComments': 'Comments',
  'chat.commentsSoon': 'Comments â coming soon',
  ...
  'chat.comments.placeholder': 'Comment on this elementâ¦',
  ...
  'chat.comments.sending': 'Sendingâ¦',
  ...
  'chat.composerPlaceholder': 'Describe what you want to generateâ¦',
  ...
  'chat.composerHint': 'â/Ctrl + Enter to send Â· include goals, content, style, and format',
  ...
  'chat.importDesignSystemSearch': 'Search design systemsâ¦',
  'chat.importDesignSystemEmpty': 'No design systems match "{query}"',
  'chat.importDesignSystemNone': 'None â freeform',
  ...
  'chat.designToolbox.prompt.contextSpecific': 'Current target: {kind} Â· {label}.',
  ...
  'chat.designToolbox.prompt.autoMatchStep1': '1. Define what âgood-looking designâ means first: audience, business goal, brand feel, style references, information density, color/type/motion/asset standards, and AI/template patterns to avoid.',
  ...
  'chat.designToolbox.prompt.selectedResource': 'Selected resource: {kind} Â· {title} ({id}).',
  ...
  'chat.mentionNoResults': 'No results for â{query}â.',
  ...
  'preview.exit': 'â¤ Exit',
  'preview.fullscreen': 'â¤¢ Fullscreen',
  'preview.closeTitle': 'Close (Esc)',
  'preview.loading': 'Loading {label}â¦',
  ...
  'workspace.loadingSketch': 'Loading sketchâ¦',
  'workspace.newTab': 'New tab',
  'workspace.searchFilesPlaceholder': 'Search tabs or filesâ¦',
  ...
  'workspace.terminalStarting': 'Starting terminalâ¦',
  ...
  'workspace.terminalReconnecting': 'Reconnectingâ¦',
  ...
  'designFiles.searchPlaceholder': 'Search filesâ¦',
  'designFiles.up': 'Up',
  ...
  'designFiles.dropTitle': 'â¤ Drop files here',
  'designFiles.dropDesc': 'Images, docs, references, or folders â the agent will use them as context.',
  ...
  'designFiles.modified': 'Modified {time} Â· {size}',
  ...
  'designFiles.moveNewFolder': 'New folderâ¦',
  ...
  'designFiles.pageInfo': '{start}â{end} of {total}',
  ...
  'designFiles.modifiedExt': 'Modified {time} Â· {size} Â· {ext}',
  ...
  'designFiles.usefulInfoTip9': 'Drag images, docs, or whole folders into this panel â the agent uses them as context.',
  'designFiles.usefulInfoTip10': 'Click New sketch to draw a rough layout and let the agent build from it.',
  'designFiles.usefulInfoTip11': 'Select any element in the preview to comment â the agent makes targeted edits.',
  ...
  'quickSwitcher.placeholder': 'Open tab or fileâ¦',
  ...
  'fileViewer.binaryMeta': 'Binary Â· {size}',
  ...
  'fileViewer.reactMeta': 'React component Â· {size}',
  'fileViewer.sketchMeta': 'Sketch Â· {size}',
  'fileViewer.markdownStreamingMeta': 'Streaming previewâ¦',
  'fileViewer.markdownErrorMeta': 'Preview may be incomplete (generation error).',
  'fileViewer.markdownStreamingStatus': 'Streamingâ¦ showing partial markdown.',
  ...
  'manualEdit.uploadingImage': 'Uploading imageâ¦',
  ...
  'fileViewer.viewportTabletTitle': 'Tablet preview at 820 Ã 1180 (modern portrait baseline)',
  'fileViewer.viewportMobile': 'Mobile',
  'fileViewer.viewportMobileTitle': 'Mobile preview at 390 Ã 844',
  ...
  'fileViewer.shareLinkPublishGuide': 'Publish online above to enable share â',
  ...
  'fileViewer.exportingProgress': 'Exportingâ¦',
  'fileViewer.exportSlideProgress': 'Exporting slide {current}/{total}â¦',
  'fileViewer.exportingElapsed': 'Exportingâ¦ {seconds}s',
  'fileViewer.exportSlideEta': 'Exporting slide {current}/{total} Â· ~{seconds}s left',
  ...
  'fileViewer.exportImageSaving': 'Saving imageâ¦',
  ...
  'fileViewer.saveAsTemplate': 'Save as templateâ¦',
  'fileViewer.savingTemplate': 'Saving templateâ¦',
  'fileViewer.savedTemplate': 'Saved as "{name}"',
  'fileViewer.savedTemplateFail': 'Could not save template â try again.',
  'fileViewer.templateNamePrompt': 'Template name',
  'fileViewer.templateNameDefault': 'Untitled template',
  'fileViewer.templateDescPrompt': 'Short description (optional â what makes this template useful?)',
  'liveArtifact.refresh.button': 'Refresh',
  'liveArtifact.refresh.buttonTitle': 'Refresh this live artifact',
  'liveArtifact.refresh.loadingTitle': 'Loading live artifactâ¦',
  'liveArtifact.refresh.noSourceTitle': 'No refresh source is available yet.',
  'liveArtifact.refresh.running': 'Refreshingâ¦',
  ...
  'liveArtifact.refresh.eventStartedDetail': 'Refresh startedâ¦',
  ...
  'liveArtifact.viewer.code.loading': 'Loading codeâ¦',
  ...
  'fileViewer.deployingToVercel': 'Deploying to Vercelâ¦',
  ...
  'fileViewer.deployingToProvider': 'Deploying to {provider}â¦',
  'fileViewer.preparingPublicLink': 'Preparing public linkâ¦',
  ...
  'fileViewer.cloudflareZonesLoading': 'Loading Cloudflare domainsâ¦',
  ...
  'fileViewer.savingConfig': 'Savingâ¦',
  ...
  'assistant.forkingConversation': 'Forkingâ¦',
  'assistant.shareToOpenDesign': 'Share to Open Design',
  'assistant.shareToOpenDesignBusy': 'Preparing packageâ¦',
  ...
  'assistant.slowHint': 'Taking longer than usual. The form usually shows in 5â10s â you can Stop and rephrase.',
  ...
  'qf.lockedSubmitted': 'Answers sent â agent is using these for the rest of the session.',
  'qf.lockedPrev': 'This form is from a previous turn.',
  'qf.hint': 'Pick what fits. Skip optional fields you don\'t care about â the agent will use sensible defaults.',
  ...
  'qf.cardRefs': 'Refs:',
  'qf.cardSampleText': 'The quick brown fox Â· 0123',
  ...
  'questions.generating': 'Generating questionsâ¦',
  'questions.skipAll': 'Skip all',
  'questions.autoSkipHint': 'Auto-continues when the timer ends',
  'artifact.odCardTaskBriefChip': 'Memory applied Â· view brief',
  ...
  'artifact.odCardRuleSaving': 'Savingâ¦',
  'artifact.odCardRuleSaved': 'Saved â{name}â as a rule',
  ...
  'critiqueTheater.interrupting': 'Interruptingâ¦',
  ...
  'critiqueTheater.shippedSummary': 'Shipped at round {round} Â· composite {composite}',
  'critiqueTheater.interruptedSummary': 'Interrupted at round {round} Â· best composite {composite}',
  ...
  'critiqueTheater.transcriptLoading': 'Loading transcriptâ¦',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Open Design â pick one and adopt.',
  ...
  'pet.tabCommunityHint': 'Hatched pets from Codex â adopt one or generate a new one.',
  ...
  'pet.customHint': 'Pick a name, glyph and accent â the overlay updates live.',
  'pet.customGreetingPlaceholder': 'Say hi from your petâ¦',
  'pet.fieldName': 'Name',
  'pet.fieldGlyph': 'Glyph',
  'pet.fieldGlyphHint': 'A single emoji works best (e.g. ð, ð¦, ð¢).',
  ...
  'pet.spriteAria': '{name} â drag to move, click to chat',
  ...
  'pet.composerTitle': 'Pets â wake, tuck, or pick one',
  ...
  'pet.atlasActiveHint': 'Animated atlas active â the pet picks a row from your interaction (hover, drag, idle).',
  ...
  'pet.slashPopoverHint': 'ââ navigate Â· enter to pick Â· esc to dismiss',
  ...
  'pet.codexLoading': 'Looking for hatched petsâ¦',
  'pet.codexRefresh': 'Refresh',
  'pet.codexAdopt': 'Adopt',
  'pet.codexAdopting': 'Adoptingâ¦',
  'pet.communitySync': 'Download community pets',
  'pet.communitySyncing': 'Downloadingâ¦',
  ...
  'pet.codexBundledTitle': 'Ships with Open Design â no download needed.',
  ...
  'settings.projectLocationsWorkBaseMeta': 'Work base Â· projects are created as subfolders here',
  'settings.projectLocationsAddFolder': 'Add folderâ¦',
  ...
  'settings.connectorsSavedWithTail': 'Saved Â· â¢â¢â¢â¢{tail}',
  ...
  'settings.connectorsKeySaved': 'Saved â',
  ...
  'settings.memoryDesc': 'One sentence â what is this memory about?',
  ...
  'settings.memoryFlashPathCopied': 'â Path copied',
  ...
  'settings.memoryProfileSaving': 'Savingâ¦',
  ...
  'settings.memoryExtractionsRefreshing': 'Refreshingâ¦',
  'settings.memoryExtractionPhaseRunning': 'Runningâ¦',
  ...
  'settings.orbit.running': 'Runningâ¦',
  ...
  'settings.orbit.pausedManualOnly': 'Paused â manual runs only',
  ...
  'settings.orbit.templateHelp': 'Steer Orbit with a skill â the selected template example prompt is injected into every Orbit run so summaries follow that template shape.',
  'settings.orbit.templateAria': 'Orbit prompt template',
  'settings.orbit.templatesLoading': 'Loading templatesâ¦',
  ...
  'settings.orbit.artifactMetaLegacy': 'Generated before live artifact support was enabled â run Orbit again to publish one.',
  ...
  'settings.memoryModelInlineHintByok': 'Optional. Reuses your chat API key â pick a cheaper model to save cost.',
  ...
  'diagnostics.exporting': 'Exportingâ¦',
  ...
  'dsManager.rowMetaUpdated': 'You Â· updated {date}',
  'dsManager.edit': 'Edit',
  ...
  'brand.librarySubtitle': 'Teach Open Design your design systems â extract one from a website, then apply it in any chat.',
  'brand.newBrand': 'New Design System',
  'brand.searchPlaceholder': 'Search your design systemsâ¦',
  ...
  'brandDetail.refining': 'Refining this design systemâ¦',
  ...
  'onboarding.buildBody': 'Open Design turns your brand into a reusable design system â then keeps everything you build on-brand and consistent.',
  ...
  'brandPicker.quickPicksLabel': 'Popular brands â click to extract',
  'brandPicker.searchPlaceholder': 'Search brandsâ¦',
  'brandPicker.allCategories': 'All',
  'brandPicker.extractAction': 'Extract',
  'brandPicker.showMore': 'Show more',
  'brandPicker.opening': 'Starting extraction â opening {brand}â¦',
  ...
  'ds.shortcutsHint': 'Shortcuts: E edit Â· C copy Â· U upload Â· R refresh Â· â« delete logo',
