...
export const en: Dict = {
  ...
  'task.followup.details': 'Analyze the key implementation details of “{topic}” in more depth.',
  'task.followup.report': 'Create a more detailed report about “{topic}” from the current result.',
  'task.followup.demo': 'Turn the current result into an interactive web demo.',
  ...
  'chat.usage.title': 'Usage',
  'chat.usage.tokensUsed': 'Tokens used',
  'chat.usage.timeWorked': 'Time worked',
  'chat.usage.inputTokens': 'Input tokens',
  'chat.usage.outputTokens': 'Output tokens',
  'chat.usage.cost': 'Cost',
  'chat.usage.rounds': 'Rounds',
