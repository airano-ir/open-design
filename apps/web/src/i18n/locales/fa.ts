...
export const fa: Dict = {
  ...
  'task.followup.details': 'جزئیات کلیدی پیاده‌سازی «{topic}» را عمیق‌تر بررسی کن.',
  'task.followup.report': 'بر اساس نتیجه فعلی، گزارش کامل‌تری درباره «{topic}» تهیه کن.',
  'task.followup.demo': 'نتیجه فعلی را به یک دموی تعاملی وب تبدیل کن.',
  ...
  'chat.usage.title': 'میزان استفاده',
  'chat.usage.tokensUsed': 'توکن‌های مصرف‌شده',
  'chat.usage.timeWorked': 'زمان کار',
  'chat.usage.inputTokens': 'توکن‌های ورودی',
  'chat.usage.outputTokens': 'توکن‌های خروجی',
  'chat.usage.cost': 'هزینه',
  'chat.usage.rounds': 'نوبت‌ها',
