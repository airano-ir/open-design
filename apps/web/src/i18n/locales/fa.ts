...
export const fa: Dict = {
  ...
  'integrations.tabLabel.agentPlugin': 'افزونه Agent',
  ...
  'agentPlugin.lede': 'افزونه Open Design را در Agent کدنویسی خود نصب کنید: مهارت‌های گردش کار به آن یاد می‌دهند که از طریق daemon محلی اسلایدها، صفحه‌ها و آثار برند بسازد، آن‌ها را به‌صورت زنده پیش‌نمایش کند و نتایج را در مرورگر خودش بررسی کند.',
  'agentPlugin.copy': 'کپی',
  'agentPlugin.copied': 'کپی شد',
  'agentPlugin.bundleMeta': 'بسته v{version} · {count} مهارت گردش کار + سرور MCP از نوع stdio',
  'agentPlugin.hostDetected': 'شناسایی شد',
  'agentPlugin.hostMissing': 'در PATH نیست',
  'agentPlugin.browserVerify': 'راستی‌آزمایی بصری در {browser} انجام می‌شود.',
  'agentPlugin.install': 'نصب',
  'agentPlugin.installing': 'در حال نصب…',
  'agentPlugin.uninstall': 'حذف نصب',
  'agentPlugin.uninstalling': 'در حال حذف…',
  'agentPlugin.requestFailed': 'daemon پاسخ نداد — مطمئن شوید Open Design در حال اجراست و دوباره تلاش کنید.',
  'agentPlugin.loadFailed': 'بارگیری وضعیت میزبان از daemon ممکن نشد.',
