...
export const fa: Dict = {
  ...
  'homeHero.title.morning': 'امروز صبح چه چیزی خلق می‌کنید؟',
  'homeHero.title.afternoon': 'امروز بعدازظهر چه چیزی خلق می‌کنید؟',
  'homeHero.title.evening': 'امشب چه چیزی خلق می‌کنید؟',
