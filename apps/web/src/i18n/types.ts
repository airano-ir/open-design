...
export interface Dict {
  ...
  'integrations.tabLabel.agentPlugin': string;
  'integrations.tabLabel.mcp': string;
  'integrations.tabLabel.skills': string;
  'integrations.tabHint.agentPlugin': string;
  'integrations.tabHint.mcp': string;
  'integrations.tabHint.connectors': string;
  'integrations.tabHint.useEverywhere': string;
  'agentPlugin.lede': string;
  'agentPlugin.copy': string;
  'agentPlugin.copied': string;
  'agentPlugin.bundleMeta': string;
  'agentPlugin.hostDetected': string;
  'agentPlugin.hostMissing': string;
  'agentPlugin.browserVerify': string;
  'agentPlugin.install': string;
  'agentPlugin.installing': string;
  'agentPlugin.uninstall': string;
  'agentPlugin.uninstalling': string;
  'agentPlugin.requestFailed': string;
  'agentPlugin.loadFailed': string;
